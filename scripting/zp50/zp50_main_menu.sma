...
show_menu_main(id)
{
	...
	menu_additem(menu, "Nâng cấp ( 1 map )"); //1
	...
	//menu_additem(menu, "Chon nhan vat cho VIP"); //7
 ...
 public menu_handler( id, menu, item )
{
	...
	switch (item)
	{
		...
		/*case 3:
		{
			...
			{
				zp_colored_print(id, "Không thể đổi pass trong  %d giây nữa", get_cant_change_pass_time(id))
			}
			else
