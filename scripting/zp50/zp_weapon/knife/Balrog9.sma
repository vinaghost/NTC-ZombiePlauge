...
#define DAMAGE_A 250 // 250 for Zombie
#define DAMAGE_B 800 // 350 for Zombie
#define DAMAGE_EXP 350 // 250 for Zombie
...
public plugin_init()
{
	...
	RegisterHamBots(Ham_TakeDamage, "fw_Player_TakeDamage");
	...
	g_item = zp_weapons_register("Balrog 9", 20, ZP_KNIFE, ZP_WEAPON_AP);


}
public zp_fw_wpn_select_post(id, ItemID)
{
    if(ItemID == g_item) Get_Balrog9(id)
}
public zp_fw_wpn_remove(id, ItemID )
{
    if(ItemID == g_item) UnSet_BitVar(g_Had_Balrog9, id)
}
