...
public plugin_init()
{
	...
	g_Janus9 = zp_weapons_register("Janus 9", 30, ZP_KNIFE, ZP_WEAPON_AP)
...
{
	if(ItemID == g_Janus9) Get_Janus9(id)
}
public zp_fw_wpn_remove(id, ItemID )
{

	if(ItemID == g_Janus9) UnSet_BitVar(g_Had_Janus9, id)
}

public zp_user_infected_post(id) UnSet_BitVar(g_Had_Janus9, id)
public zp_user_humanized_post(id) UnSet_BitVar(g_Had_Janus9, id)
