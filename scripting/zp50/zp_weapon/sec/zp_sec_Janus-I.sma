...
public plugin_init()
{
	...
	g_Janus1 = zp_weapons_register("Janus 1", 25, ZP_SECONDAYRY, ZP_WEAPON_AP)
...
{
    if(ItemID == g_Janus1) Get_Janus1(id)
}
public zp_fw_wpn_remove(id, ItemID )
{
    if(ItemID == g_Janus1) Remove_Janus1(id)
}

public zp_user_infected_post(id) Remove_Janus1(id)
public zp_user_humanized_post(id) Remove_Janus1(id)
