...
#define DAMAGE 84 // 84 for zombie
#define CLIP 7
#define BPAMMO 35
...
{
    if(ItemID == g_Thanatos1) Get_Thanatos1(id)
}
public zp_fw_wpn_remove(id, ItemID )
{
    if(ItemID == g_Thanatos1) Remove_Thanatos1(id)
}

public zp_user_infected_post(id) Remove_Thanatos1(id)
public zp_user_humanized_post(id) Remove_Thanatos1(id)
