...
public plugin_init()
{
	...
	g_janus11 = zp_weapons_register("Janus 11", 50, ZP_PRIMARY, ZP_WEAPON_AP)
}
...
{
    if(ItemID == g_janus11) Get_Janus11(id)
}
...
public zp_user_infected_post(id) Remove_Janus11(id)
public zp_user_humanized_post(id) Remove_Janus11(id)
