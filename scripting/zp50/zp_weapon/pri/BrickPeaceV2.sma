...
#define DAMAGE_B 700 // 300 for Zombie
...
public plugin_init()
{
	...
	g_item = zp_weapons_register("Brick Peace V2", 25, ZP_PRIMARY, ZP_WEAPON_AP);
...
{
    if(ItemID == g_item) Get_BlockAR(id)
}
public zp_fw_wpn_remove(id, ItemID )
{
    if(ItemID == g_item) Remove_BlockAR(id)
}
