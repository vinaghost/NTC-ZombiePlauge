...
public plugin_init()
{
	...
	g_janus5 = zp_weapons_register("Janus 5", 50, ZP_PRIMARY, ZP_WEAPON_AP)
}
...
{
    if(ItemID == g_janus5) Get_Janus5(id)
}
public zp_fw_wpn_remove(id, ItemID )
{
    if(ItemID == g_janus5) Remove_Janus5(id)
}

public zp_user_infected_post(id) Remove_Janus5(id)
public zp_user_humanized_post(id) Remove_Janus5(id)
