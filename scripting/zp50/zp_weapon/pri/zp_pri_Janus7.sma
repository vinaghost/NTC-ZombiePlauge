...
public plugin_init()
{
	...
	g_janus7 = zp_weapons_register("Janus 7", 85, ZP_PRIMARY, ZP_WEAPON_AP)
}
...
{
    if(ItemID == g_janus7) Get_Janus7(id)
}
public zp_fw_wpn_remove(id, ItemID )
{
    if(ItemID == g_janus7) Remove_Janus7(id)
}

public zp_user_infected_post(id) Remove_Janus7(id)
public zp_user_humanized_post(id) Remove_Janus7(id)
