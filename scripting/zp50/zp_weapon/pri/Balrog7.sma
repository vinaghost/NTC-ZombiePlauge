...
new g_Event_BALROG7, g_SmokePuff_SprId, g_RifleShell_Id, g_SprId, g_MaxPlayers
new g_item;
...
public plugin_init()
{
	...
	g_item = zp_weapons_register("Balrog 7", 25, ZP_PRIMARY, ZP_WEAPON_AP);
...
{
    if(ItemID == g_item) Get_BALROG7(id)
}
public zp_fw_wpn_remove(id, ItemID )
{
    if(ItemID == g_item) Remove_BALROG7(id)
}
