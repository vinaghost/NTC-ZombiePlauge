...
new g_Msg_CurWeapon, g_MsgWeaponList
new g_item;
...
public plugin_init()
{
	...
	RegisterHamBots(Ham_TakeDamage, "fw_TakeDamage_PlayerPost", 1)
	...
	g_item = zp_weapons_register("Vandita", 25, ZP_PRIMARY, ZP_WEAPON_AP);
...
{
    if(ItemID == g_item) Get_Weapon(id)
}
