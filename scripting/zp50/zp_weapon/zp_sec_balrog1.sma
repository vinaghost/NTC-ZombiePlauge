...
ApplyMultiDamage(iEntity, iAttacker)
{
	...
	#else
		static OrpheuFunction:handleApplyMultiDamage

		if(handleApplyMultiDamage || (handleApplyMultiDamage = OrpheuGetFunction("ApplyMultiDamage")))
		{
			  OrpheuCall(handleApplyMultiDamage, iEntity, iAttacker)
		}
	#endif
}
