...
public plugin_init()
{
	...
	cvar_painshockfree_zombie = register_cvar("zp_painshockfree_zombie", "2") // 1-all // 2-first only // 3-last only
	cvar_painshockfree_human = register_cvar("zp_painshockfree_human", "1") // 1-all // 2-last only
