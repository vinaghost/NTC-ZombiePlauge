...
new modetext[][] = { "Bình thường", "Khoanh vùng", "Nổ ngay và luôn", "Laser", "Motion sensor", "Satchel chage", "Homing" }
...
public plugin_init()
{
	...
	register_option(OPTION_HOMING_ENABLED, "nademodes_homing_enabled", "0")
...
public changemode(id, NadeRace:NADE_TYPE)
{
	...
	switch (mode[id][NADE_TYPE])
	{
		case NADE_NORMAL:
		{
			client_print(id, print_center, "Chế độ - Bình thường")
		}

		case NADE_PROXIMITY:
		{
			client_print(id, print_center, "Chế độ - Khoanh vùng")
		}

		case NADE_IMPACT:
		{
			client_print(id, print_center, "Chế độ - Nổ ngay và luôn")
		}

		case NADE_TRIP:
		{
			client_print(id, print_center, "Chế độ - Laser")
		}
