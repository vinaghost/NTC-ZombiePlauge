...
#define PLUGIN "[ZP] Weapon: Lightning BIG-EYE"
#define VERSION "1.0"
#define AUTHOR "Dias"
...
new const wp_model[3][] = {
	"models/zombie_plague/weapon/sec/v_waterpistol.mdl",
	"models/zombie_plague/weapon/sec/p_waterpistol.mdl",
	"models/zombie_plague/weapon/sec/w_waterpistol.mdl"
}
...
public get_weapon(id)
{
	...
	cs_set_user_bpammo(id, WP_BASEON, 80)
