...
public plugin_init()
{
	...
	cvar_admin_models_human_player = register_cvar("zp_admin_models_human_player", "0")
	cvar_admin_models_human_knife = register_cvar("zp_admin_models_human_knife", "0")
	cvar_admin_models_zombie_player = register_cvar("zp_admin_models_zombie_player", "0")
	cvar_admin_models_zombie_knife = register_cvar("zp_admin_models_zombie_knife", "0")
}
