...
// Defaults
new const weapon_names[][] = {"AWP Magnum Sniper", "M249 Para Machinegun", "SG550 Auto-Sniper", "G3SG1 Auto-Sniper" }
new const weapon_items[][] = { "weapon_awp", "weapon_m249", "weapon_sg550", "weapon_g3sg1" }
...
public plugin_init()
{
	...
	for (index = 0; index < ArraySize(g_weapon_items); index++)
	{
		...
		ArrayPushCell(g_weapon_itemid, zp_money_items_register(weapon_name, ITEM_COST))
	}
}
